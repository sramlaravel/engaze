        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  open ">
                <a href=""><i class="la la-home"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">اضافه الاسلايدات</span>
                    <span  class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\Sliders::count()}} </span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.Sliders')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.Sliders.create')}}" data-i18n="nav.dash.crypto">أضاف اسلايدم جدبد   </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  open ">
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.languages.create')}}" data-i18n="nav.dash.crypto">أضاف كلام جدبد جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  open ">
                <a href=""><i class="la la-home"></i>
                    ...
                    <span  class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\MainCategories::count()}} </span>
                </a>
                <ul class="menu-content">
